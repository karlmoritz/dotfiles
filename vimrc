...
fun! SetupVAM()
  ...
  call vam#ActivateAddons(['github:jistr/vim-nerdtree-tabs'], {'auto_install' : 1})
  call vam#ActivateAddons(['Solarized'], {'auto_install' : 1})
  call vam#ActivateAddons(['C11_Syntax_Support'], {'auto_install' : 1})
  call vam#ActivateAddons(['clang_complete'], {'auto_install' : 1})
  call vam#ActivateAddons(['UltiSnips'], {'auto_install' : 1})
  call vam#ActivateAddons(['bufkill'], {'auto_install' : 1})
  " call vam#ActivateAddons(['xptemplate'], {'auto_install' : 1})
  call vam#ActivateAddons(['SuperTab%1643'], {'auto_install' : 1})
  call vam#ActivateAddons(['a'], {'auto_install' : 1})
  call vam#ActivateAddons(['SingleCompile'], {'auto_install' : 1})
  call vam#ActivateAddons(['hg:http://hg.dfrank.ru/vim/bundle/dfrank_util'], {'auto_install' : 1})
  call vam#ActivateAddons(['hg:http://hg.dfrank.ru/vim/bundle/vimprj'], {'auto_install' : 1})
  call vam#ActivateAddons(['github:oblitum/rainbow'], {'auto_install' : 1})
